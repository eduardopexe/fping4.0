...
if ($ex_link eq '1-|2-'){
   ...
   if ($cli=~/psys/){
      $devices{"-"}="400,355";
      $devices{"mbmbi01"}="45,255";
      $devices{"mbenc01"}="1145,505";
   }
}
...
###########posiciona no centro para psys
            ...
            if ($mna=~/mb|sw|rb/ and @dados_mttr[8]=~/psys/ and $posicionado_a eq 'nao'){
...
########
 #           else{
               ...
               if ($cli=~/brad|unib/ and @dados_mttr[8]=~/rbave|rboco|rbcti|swcti|rbcau/ and $posicionado_a eq 'nao'){
...
#                    $lin++;
        ...
        #       }
           ...
           ####host b
            ...
            if ($mnb=~/mb|sw|rb/ and @dados_mttr[13]=~/psys/ and $posicionado_b eq 'nao'){
  ...
  #          else{
               ...
               if ($cli=~/brad|unib/ and @dados_mttr[13]=~/rbave|rboco|rbcti|swcti|rbcau/ and $posicionado_b eq 'nao'){
...
print topo "<html>\n";
print topo "<head>";
print topo "   <title>$cli - $tipo_mapa :: FPING 4.0 - NETWORK MAP - </title>\n";
