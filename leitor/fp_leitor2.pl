...
###########posiciona no centro para psys
            #### fim posicao bkb a
               ...
               if ($mna=~/mb|sw|rb|rs|ru|rf/ and $cli=~/brad|unib/){
...
#                    $lin++;
           ...
           ####host b
            ...
            #### fim posicao bkb a
               ...
               if ($mnb=~/mb|sw|rb|rs|ru|rf/ and $cli=~/brad|unib/){
...
print topo "<html>\n";
print topo "<head>";
print topo "   <title>FPING 4.0 - NETWORK MAP - $dir</title>\n";
