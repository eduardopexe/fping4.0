...
echo "<font size=2><a href='http://10.98.22.10/links_bkb2.0/views/links_fping.asp' target='_blank'>Atualizar BD-FPING</a></font> ||| ";
...
include_once("mon_sum_cqmri.php");
#include_once("/fping_mon/www/fping_mon/mon_ebtv_sum.php");
include_once("/fping_mon/www/fping_mon/mon_spb_sum.php");
include_once("/fping_mon/www/fping_mon/mon_rtt_sum.php");
include_once("/fping_mon/www/fping_mon/mon_ras_sum.php");
...
include_once("/fping_mon/www/fping_mon/mon_cti_sum.php");
