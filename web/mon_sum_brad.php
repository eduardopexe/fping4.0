...
###
   #abre arquivo com alarmes

   $fpl = file("/fping4.0/web/resultado/$dir/res_$dir.txt");

   $qt_no_chk=0;

   foreach ( $fpl as $linhal ) {
      ...
      $check_infol=$resl[22];
       ...
       if ($statusl=="falha") {
         ...
         if ($check_infol=="check"){

            continue;
         }

         $file_t="/fping4.0/web/bd/check_list/".$tstpl."_".$codl.".txt";

#echo "$file_t ".is_file($file_t)."<br> ";
#$tt=is_file($file_t);
...
echo "<bgsound src=\"http://$ips/fping4.0/alerta_sonoro/alarme_$dir.wav\" loop=3 hidden=true volume=100 >";
...
echo "<td colspan='2' width='50' height='0'>";
