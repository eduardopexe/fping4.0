...
$link_chk_all="<a href='http://$ips/fping4.0/bd/check_Update_n.php?cli=$dir&cor=$ver&acao=checkall&stalm=falha' target=_blank>";
...
$link_chk_all=$link_chk_all."</a>";
     ...
     echo "<td width='220'>host_a int_a - host_b int_b</td>";
      ...
      echo "<td width='48' align='center'>$link_chk_all</td>";
      echo "<td width='32' align='center'></td>";
     echo "<td width='200'>obs</td>";
      echo "<td width='50'>info</td>";
      echo "</tr>";
      rsort($fp);
##################paginacao
...
############# fim memoria
         ...
         if ($status=="falha" and  $mn_tipo<>"dev") {
...
$vcolory="#FFFFFF";
        ...
        echo "<td width='200' bgcolor='$corx'>$obsx</td>";
         echo "<td bgcolor='$vcolor' width='50'>$mn_tipo</td>";
         echo "</tr>";
