...
#echo "$som ; $liga_som ; http://$ips/fping_mon/alerta_sonoro/alarme_$dir.wav <br>";
      echo "<bgsound src='http://$ips/fping4.0/alerta_sonoro/alarme_$dir.wav' loop='1'>";
#echo "<EMBED SRC='http://$ips/fping4.0/alerta_sonoro/alarme_$dir.wav' WIDTH='0' HEIGHT='0' AUTOSTART='true' STARTTIME='00:00' ENDTIME='00:14'>";
   }
